 ...
 * Essential notification functionality for immediate loading
 */

import { NotificationOptions, ToastConfig, NotificationType } from '../types';

export class NotificationManagerCore {
  ...
  /**
   * Show basic notification (core functionality)
   */
  ...
  /**
   * Remove specific notification (core functionality)
   */
  ...
  /**
   * Clear all notifications (core functionality)
   */
  clear(): void {
